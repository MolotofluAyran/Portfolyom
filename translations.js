const translations = {
    tr: {
        ...
        // Hero Section
        'hero.title': 'Merhaba, Ben Egemen',
        'hero.subtitle': 'Teknik Artist',
        'hero.cta': 'Projelerimi Keşfet',
        
        // About Section
        'about.title': 'Hakkımda',
        'about.text1': 'Merhaba! Ben Egemen, tasarım ve teknoloji tutkunu bir artistim.',
        'about.text2': 'Hem 3B alanda hem 2B alanda çalışmayı severim. Çizim yapmayı, kod yazmayı ve yeni projeler geliştirmeyi seviyorum.',
        'about.text3': 'Her zaman yeni şeyler öğrenmeye açığım ve yaratıcı projelerde yer almak için sabırsızlanıyorum.',
        
        // Drawings Section
        'drawings.title': 'Çizimlerim',
        'drawings.overlay1': 'En Gurur Duyduğum Çizimim!',
        'drawings.overlay2': 'Chibi Tarzı Çizme Denemelerimden Birisi',
        'drawings.overlay3': 'İnsanlar cidden buraları okuyor mu?',
    ...
    en: {
        ...
        // Hero Section
        'hero.title': 'Hello, I\'m Egemen',
        'hero.subtitle': 'Technical Artist',
        'hero.cta': 'Explore My Projects',
        
        // About Section
        'about.title': 'About Me',
        'about.text1': 'Hello! I\'m Egemen, a design and technology enthusiast artist.',
        'about.text2': 'I love working in both 3D and 2D. I enjoy drawing, coding, and developing new projects.',
        'about.text3': 'I\'m always open to learning new things and eager to participate in creative projects.',
        
        // Drawings Section
        'drawings.title': 'My Drawings',
        'drawings.overlay1': 'My Most Proud Drawing!',
        'drawings.overlay2': 'One of My Chibi Style Drawing Attempts',
        'drawings.overlay3': 'Do people really read this?',
